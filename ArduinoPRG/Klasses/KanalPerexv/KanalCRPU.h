...
class KanalCRPU {
public:
	KanalCRPU(int Mod_kanalNum, int Blok_kanalNum, double Polosa);
	~KanalCRPU();
	...
	bool AmpSET;
	int LNA;
	int Ispoln;  // 0-бит LNA параф Диапазон SW11-SW13 1-каждый бит LNA и Диапазон
