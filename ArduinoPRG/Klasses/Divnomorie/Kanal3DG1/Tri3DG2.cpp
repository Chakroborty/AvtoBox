...
//---------------------------------------------------------------------------
 Tri3DG2::Tri3DG2(int ADR)
 { BL_NumModul = ADR<<28;
   MKanal  = new KanalDGUKV(1,1,30);
...
//---------------------------------------------------------------------------
void Tri3DG2::SeFriq(int Mod,int Kanal,double Fin,bool Ampl,int DB1,int DB2)
{
			switch (Mod)
   { case 0:
...
int Tri3DG2::LoadKL_K1(int tip)
{
	return  BL_NumModul + MKanal->LoadKL(tip);
}
//---------------------------------------------------------------------------
void Tri3DG2::Set_ATT1_K1(double dB)
{
	MKanal->ATT1_SET(dB);
}
void Tri3DG2::Set_ATT2_K1(double dB)
{
	MKanal->ATT2_SET(dB);
}
int Tri3DG2::LoadATT_K1(int tip)
{
	return  BL_NumModul + MKanal->LoadATT(tip);
}

//---------------------------------------------------------------------------
DWORD Tri3DG2::LoadGET1_H(){
  return  MKanal->LoadGET1H();
}
DWORD Tri3DG2::LoadGET1_L(int REG)
{
  return  BL_NumModul + MKanal->LoadGET1(REG);
}
//---------------------------------------------------------------------------
DWORD Tri3DG2::LoadGET2_H(void){
  return  MKanal->LoadGET2H();
}
DWORD Tri3DG2::LoadGET2_L(int REG)
{
