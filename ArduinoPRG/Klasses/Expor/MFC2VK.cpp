...
//	Polosa[3].DFv = 4380;Polosa[3].DF830 = 1015.3846153846153846153846153846; Polosa[3].DNSys = 8; //if (Fg4159==875) {NumDapazon = 3;}  3 Initfreq(Fg4159,0,0,6,40,1,1);
//	Polosa[3].DK1 = 1;     Polosa[3].DNDel = 1;Polosa[3].DNOut = 5;
//	Polosa[3].DFref = 112.30769230769230769230769230769;

//	Polosa[1].DFv = 4602;Polosa[1].DF830 = 996.08695652173913043478260869565; Polosa[1].DNSys = 9; //if (Fg4159==2300) {NumDapazon = 1;}  1 Initfreq(Fg4159,0,0,4,40,1,1);
//	Polosa[1].DK1 = 0;     Polosa[1].DNDel = 1;Polosa[1].DNOut = 2;
//	Polosa[1].DFref = 100.04347826086956521739130434783;
...
double MFC2VK::Initfreq(double Freq,int K1,int K2,double  NDel,int SysN,int AR,int AN)
{    switch(K1)
	  {   case 0:
		  Pol1 = -1;
		  break;
 ...
 */
double MFC2VK::SetFreq(double Fg4159,int Fas1,int Log)
	{
/**
...
void MFC2VK::SetKLUCH(struct Divider *DXX,int PDIV1,int PS0,int PN0,int PN1,int PN2,int PBYP)
   {/*----------  Процедура SetKLUCH  ----------*/
   ...
   =            Section  DivSet                 =
   =============================================*/
void MFC2VK::DivSet (struct Divider *DXX,int Div)
  {               /*HMC705SET*/
...
long MFC2VK::SintLOAD_L(int dev,int Poz)
...
/***********************************************************************************/
long MFC2VK::SintLOAD_H(int dev)
   {
	switch(dev)
		{   case 1:
			return  AdrMod|MFC2VK::AdrDev::PLL1<<24;
			break;
			case 2:
			return  AdrMod|MFC2VK::AdrDev::PLL2<<24;
			break;
			case 3:
			return  AdrMod|MFC2VK::AdrDev::PLL3<<24;
			break;
			case 4:
			return  AdrMod|MFC2VK::AdrDev::PLL4<<24;
			break;
			case 5:
			return  AdrMod|MFC2VK::AdrDev::PLL5<<24;
			break;
			default: return  AdrMod|MFC2VK::AdrDev::PLL3<<24;
		}
   }
