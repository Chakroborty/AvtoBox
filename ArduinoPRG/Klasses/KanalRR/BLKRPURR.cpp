...
void RPURR::LoadMFC11(double F, int ADR)
...
void RPURR::LoadMFC2(double F, int ADR)
...
void RPURR::SetFreq(double F,double Fat,int ATT1,int ATT2,int ATT3,int Kanal,int ALL,int BPERENOS)
{//TODO: Установка частоты @SETFRIQ (BLKRPURR.cpp)
	switch (Kanal)
...
void RPURR::LoadRPURR1()//LoadRPURRALL
{ //TODO: Прогрузка частоты Блок @Прогрузка(2)
	int i =0;
  // TODO: Прогрузка Ключи короткая МФЧ @Прогрузка(2)
