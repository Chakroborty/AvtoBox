...
double MMFC2RR::Initfreq(double Freq,int K1,int K2,double  NDel,int SysN,int AR,int AN)
{    switch(K1)
	  {   case 0:
		  Pol1 = -1;
		  break;
 ...
 */
double MMFC2RR::SetFreq(double Fg4159,int Fas1,int Log)
	{
/**
...
void MMFC2RR::SetKLUCH(struct Divider *DXX,int PDIV1,int PS0,int PN0,int PN1,int PN2,int PBYP)
   {/*----------  Процедура SetKLUCH  ----------*/
   ...
   =            Section  DivSet                 =
   =============================================*/
void MMFC2RR::DivSet (struct Divider *DXX,int Div)
  {               /*HMC705SET*/
...
long MMFC2RR::SintLOAD_L(int dev,int Poz)
...
long MMFC2RR::SintLOAD_H(int dev)
   {
	switch(dev)
		{   case 1:
			return  AdrMod|MMFC2RR::AdrDev::PLL1<<24;
			break;
			case 2:
			return  AdrMod|MMFC2RR::AdrDev::PLL2<<24;
			break;
			case 3:
			return  AdrMod|MMFC2RR::AdrDev::PLL3<<24;
			break;
			case 4:
			return  AdrMod|MMFC2RR::AdrDev::PLL4<<24;
			break;
			case 5:
			return  AdrMod|MMFC2RR::AdrDev::PLL5<<24;
			break;
			default: return  AdrMod|MMFC2RR::AdrDev::PLL3<<24;
		}
   }
